...
import { collection, onSnapshot, query, orderBy, limit, setDoc, doc, addDoc, deleteDoc, updateDoc, getDoc } from 'firebase/firestore';
    ...
    try {
      ...
      if (snap.exists()) {
        ...
        await updateDoc(docRef, {
          ...(data.dados ? { 'dados.nome': editEnvNome } : {}),
